...
export const plans: Plan[] = [
  {
    ...
    limits: [
      "Up to 2 workspaces",
      "Up to 5 people",
      "Reminders up to 20 lists",
      "Secrets up to 50 records",
      "Documents up to 50 files / 1 GB",
      "Finance with 2 accounts",
    ],
    modules: ["Reminders", "Secrets", "Calendar", "Documents", "Finance"],
    integrations: ["Calendar (basic)"],
    badge: "Starter",
  },
  {
    name: "Pro",
    ...
    limits: [
      "Up to 5 workspaces",
      "Up to 30 people",
      "Reminders up to 150 lists",
      "Secrets up to 300 records",
      "Documents up to 10 GB",
    ],
    modules: [
      "Reminders",
      "Secrets",
    ...
    integrations: ["Up to 3 calendar integrations"],
    badge: "Popular",
  },
  {
    name: "Business",
    audience: "Growth",
    priceLabel: "Custom",
    limits: ["Unlimited workspaces", "Unlimited people", "All modules"],
    modules: ["All modules", "Advanced analytics", "Custom workflows"],
    integrations: ["Unlimited integrations", "SSO", "Custom API"],
    badge: "Enterprise",
  },
];
