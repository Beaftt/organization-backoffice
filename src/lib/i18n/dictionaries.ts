...
export const dictionaries = {
  pt: {
    ...
    finance: {
      subtitle: "Registre o que entrou e saiu no mês.",
      ...
      subscriptionToggleHint:
        "Use isso para destacar cobranças recorrentes como serviços e plataformas.",
      none: "Nenhum",
      creditTitle: "Cartões de crédito",
      billSubtitle: "Veja o que ainda está em aberto no ciclo",
      billTitle: "Ciclo do cartão",
      ...
      tagsEmpty: "Sem tags",
      participantsLabel: "Participantes",
      participantsHint: "Marque quem entrou nessa transação.",
      ...
      activeLabel: "Manter esta cobrança ativa",
      pauseAction: "Pausar",
      resumeAction: "Retomar",
      subscriptionSummaryActive: "Ativas",
      subscriptionCalendarTotal: "Total do mês",
      subscriptionSummaryAnnual: "Projeção anual",
      typesLabel: "Categorias e tags",
      investDepositAmount: "Valor a depositar",
      ...
      transactionWorkspaceEmpty:
        "Selecione uma transação da lista ou inicie um novo lançamento para editar sem sair do contexto.",
      transactionWorkspaceHelper:
        "O painel fica ancorado ao lado da lista para acelerar criação, revisão e ajuste fino.",
      transactionWorkspaceTitle: "Workspace de transações",
      transactionRouteTitle: "Rota financeira",
      paymentBehaviorTitle: "Comportamento do pagamento",
      reviewLabel: "Resumo",
    ...
    calendar: {
      ...
      subscriptionBadge: "Assinatura",
      subscriptionDescription: "Assinatura do Financeiro",
      subscriptionManagedInFinance:
        "Gerencie esta assinatura em Finanças > Ajustes.",
  ...
  en: {
    ...
    finance: {
      subtitle: "Track what came in and out this month.",
      summaryIncome: "Income",
      summaryExpense: "Expenses",
      summaryNet: "Net",
      summaryAccounts: "Accounts",
      ...
      sortAmount: "Amount",
      titleLabel: "Title",
      titleMinLength: "Provide a title with at least 2 characters.",
      titleRequired: "Provide a title.",
      amountLabel: "Amount",
      amountRequired: "Provide an amount.",
      dateLabel: "Date",
      ...
      accountTypeLabel: "Account type",
      accountRequired: "Provide an account.",
      creditCardRequired: "Select a card.",
      methodLabel: "Payment method",
      subscriptionToggleLabel: "Is this a subscription?",
      subscriptionToggleHint:
        "Use this to highlight recurring charges such as services and platforms.",
      none: "None",
      creditTitle: "Credit cards",
      billSubtitle: "See what is still open in the cycle",
      billTitle: "Card cycle",
      ...
      participantsHint: "Mark who was part of this transaction.",
      listTitle: "Entries",
      tableTitle: "Title",
      tableType: "Type",
      tableDate: "Date",
      ...
      recurringAdd: "New programmed charge",
      activeLabel: "Keep this charge active",
      pauseAction: "Pause",
      resumeAction: "Resume",
      subscriptionSummaryActive: "Active",
      subscriptionCalendarTotal: "Month total",
      subscriptionSummaryAnnual: "Annual forecast",
      typesLabel: "Categories and tags",
      investDepositAmount: "Deposit amount",
      paymentMethodsTotal: "Total",
      ...
      transactionWorkspaceEmpty:
        "Select a transaction from the list or start a new entry to edit without leaving context.",
      transactionWorkspaceHelper:
        "The panel stays anchored beside the list to speed up creation, review, and fine adjustments.",
      transactionWorkspaceTitle: "Transaction workspace",
      transactionRouteTitle: "Finance route",
      paymentBehaviorTitle: "Payment behavior",
      reviewLabel: "Summary",
    ...
    calendar: {
      ...
      subscriptionBadge: "Subscription",
      subscriptionDescription: "Finance subscription",
      subscriptionManagedInFinance:
        "Manage this subscription in Finance > Setup.",
